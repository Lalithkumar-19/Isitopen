...
export function SearchSection() {
    ...
    const [city, setCity] = useState(""); // Add city state (Note: in previous code input wasn't bound, fixing that too)
        ...
        <section className="py-20 bg-[#1a3c28] relative overflow-hidden">
            ...
            <div className="relative max-w-5xl mx-auto px-6 lg:px-8 text-center">
                ...
                <motion.p
                    ...
                    viewport={{ once: true }}
                    className="text-emerald-100/80 mb-10 text-lg max-w-2xl mx-auto"
                >
                ...
                >
                    ...
                    {categories.map((cat, i) => (
                        <button
                            ...
                            onClick={() => {
                                setQuery(cat);
                                // Optional: auto search logic could go here
                            }}
                        >
                            {cat}
                        </button>
